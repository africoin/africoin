...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 1000000000000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 1000000000000); // Litecoin: 840k blocks in ~4 years
...
unsigned char pchMessageStart[4] = { 0xd2, 0xa8, 0xc6ca, 0xfd }; // Litecoin: increase each by adding 2 to bitcoin's value.
